...
const projects = [
  ...
  },
  {
    ...
    focus: "合同审查 + 风险提示",
    summary:
      "面向企业经营者、法务及人力资源人员，构建基于 RAG 的中文合同智能审查系统，支持 DOCX/PDF 上传并输出风险提示、法律依据、修改建议与修订对比。",
    challenge:
      "面向企业经营者、法务及人力资源人员，构建基于 RAG 的中文合同智能审查系统，支持 DOCX/PDF 上传并输出风险提示、法律依据、修改建议与修订对比。",
    stack: [
      "Vue 3",
    ...
    contributions: [
      "实现合同文本提取、条款切分、向量检索、法律依据召回与大模型审查结果生成。",
      "完成 1,260 条《民法典》法条结构化处理与向量索引，支持审查意见与具体法条关联溯源。",
      "覆盖试用期、合同期限、竞业限制、违约金、社会保险等风险校验，并生成可直接参考的修改建议。",
    ],
    outcome:
      "支持 DOCX/PDF 合同上传、风险问题清单、法律依据展示、修改建议与修订文本差异对比；后端 16 项自动化测试全部通过，前端生产环境构建成功。",
